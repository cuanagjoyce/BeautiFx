        ...
        children: [
          ...
          Padding(
           padding: EdgeInsets.only(top:125,left:5),
            child: Container(
                   child: FlatButton(
                   child: Text('Oily Skin', style: TextStyle(fontSize: 18.0, fontFamily: 'Raleway',color: Colors.black,
                   shadows: <Shadow>[
                    Shadow(
                      offset: Offset(1.0, 2.0),
                      blurRadius: 2.0,
         ...
         Column(children: [
            Container(child:
            Padding(
               padding: EdgeInsets.only(top:320,left: 50,right: 95),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #1: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Dont cleanse too much.',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
          ...
          Container(child:
            Padding(
               padding: EdgeInsets.only(top:1,left: 50,right: 58),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #3: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Avoid super-gentle cleansers.',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
               ...
               padding: EdgeInsets.only(top:1,left: 50,right: 115),
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text:'Avoid Harsh Soaps',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
