...
import 'package:beautifx/routines/combination/morning.dart';
import 'package:beautifx/routines/combination/evening.dart';
        ...
        children: [
          ...
          Padding(
           padding: EdgeInsets.only(top:125,left:5),
            child: Container(
                   child: FlatButton(
                   child: Text('Combination Skin', style: TextStyle(fontSize: 18.0, fontFamily: 'Raleway',color: Colors.black,
                   shadows: <Shadow>[
                    Shadow(
                      offset: Offset(1.0, 2.0),
                      blurRadius: 2.0,
          ...
          Container(
            child: Text ('Combination skin is simply having oily skin in some areas of your face and dry skin in other areas.\n\nTypically, theres a mix of oily and dry areas on different parts of your face, with the t-zone (forehead, nose, and chin) being slightly to very oily.',
         ...
         Column(children: [
            Container(child:
            Padding(
               padding: EdgeInsets.only(top:320,left: 50,right: 70),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #1: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Avoid using drying cleansers',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
          ...
          Container(child:
            Padding(
               padding: EdgeInsets.only(top:1,left: 50,right: 46),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #2: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Dont use alcohol-based products',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
          ...
          Container(child:
            Padding(
               padding: EdgeInsets.only(top:1,left: 50,right: 117),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #3: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Avoid Harsh Scrubs',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
          ...
          Container(child:
            Padding(
               padding: EdgeInsets.only(top:1,left: 50,right: 70),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #4: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Avoid Oil-Based Moisturizer',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
