...
import 'package:beautifx/routines/normal/morning.dart';
import 'package:beautifx/routines/normal/evening.dart';
        ...
        children: [
          ...
          Padding(
           padding: EdgeInsets.only(top:125,left:5),
            child: Container(
                   child: FlatButton(
                   child: Text('Normal Skin', style: TextStyle(fontSize: 18.0, fontFamily: 'Raleway',color: Colors.black,
                   shadows: <Shadow>[
                    Shadow(
                      offset: Offset(1.0, 2.0),
                      blurRadius: 2.0,
          ...
          Container(
            child: Text ('Skin is generally classified as “normal” if it isnt overly oily or dry and doesnt face any persistent skin concerns or conditions.\nThis well-balanced skin type has even levels of moisture and hydration, uniform texture and no obvious problem areas (in other words, youve hit the skin care jackpot)',
         ...
         Column(children: [
            Container(child:
            Padding(
               padding: EdgeInsets.only(top:320,left: 50,right: 75),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #1: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Wash your face',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
               ...
               padding: EdgeInsets.only(top:1,left: 50,right: 40),
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text:'Avoid Harsh Products',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
          ...
          Container(child:
            Padding(
               padding: EdgeInsets.only(top:1,left: 50,right: 50),
                child: RichText(
                  text: TextSpan(
                    text: 'Tips #3: ',
                    style: TextStyle(
                    ...
                    children: [
                      TextSpan(text:'Avoid Over-Hydrate',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
               ...
               padding: EdgeInsets.only(top:1,left: 50,right: 50),
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text:'Neglect to Exfoliate',style: TextStyle(color: Colors.black.withOpacity(0.8)),)
                       ],
                      ),
                    ),
                   ),
